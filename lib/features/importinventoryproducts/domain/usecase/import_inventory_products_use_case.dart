...
class ImportInventoryProductsUseCase extends BaseUseCase<Future<Either<Failure, List<ImportedInventoryProduct>>>, ImportInventoryProductsParams> {
  final GetAvailableGoogleDriveFilesRepository repository;

  ImportInventoryProductsUseCase({this.repository});

  @override
  Future<Either<Failure, List<ImportedInventoryProduct>>> call(ImportInventoryProductsParams params) async {
